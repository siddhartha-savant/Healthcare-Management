...
private boolean checkUserIdExists(String userName) {
    ...
    private void populateTable() {
        ...
        private void populateAdminTable(Enterprise enterprise1) {
            ...
            for (UserAccount user : enterprise1.getUserAccountList().getUserAccountList()) {
    ...
    private void initComponents() {
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 390, 510, 190));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnCreateAdmin, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26))
        );
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 110, 530, 210));
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 500, 310, 220));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/faint-bggg.jpeg"))); // NOI18N
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 1520, 830));
    ...
    private void enterpriseJTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_enterpriseJTableMouseClicked
       ...
       txtName.setText(enterprise2.getOrganizationName());
    ...
    private void btnCreateAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateAdminActionPerformed
        ...
        Employee employee = enterprise.getEmployeeList().createEmployee(txtAdminName.getText());       
