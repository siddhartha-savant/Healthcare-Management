...
public class StatisticsJPanel extends javax.swing.JPanel {
    ...
    private void imgPieMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imgPieMouseClicked
        ...
        pieDataset.setValue("BoneMarrow Donor", system.getDonorList().getDonorList().size());
        pieDataset.setValue("BoneMarrow Patient(Receiver)", system.getPatientList().getPatientList().size());
...
//        linechartdata.setValue(7, "No. Of Work Request","Day3");
        linechartdata.setValue(system.getDonorList().getDonorList().size(),"Patients/Donors","BoneMarrow Donor");
        linechartdata.setValue(system.getPatientList().getPatientList().size(),"Patients/Donors","BoneMarrow Patient(Receiver)");
...
//        barchartdata.setValue(7, "No. Of Work Request","Day3");
        barchartdata.setValue(system.getDonorList().getDonorList().size(),"Patients/Donors","BoneMarrow Donor");
        barchartdata.setValue(system.getPatientList().getPatientList().size(),"Patients/Donors","BoneMarrow Patient(Receiver)");
