 ...
 * @author Tejas
 */
public class ManageHealthServiceManagerProfile extends javax.swing.JPanel {
    ...
    public ManageHealthServiceManagerProfile(UserAccount userAccount, HealthServiceManagerOrganization systOrganization, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("DOB:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 290, -1, -1));

        txtName.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 70, 146, -1));

        txtContact.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(txtContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 110, 146, -1));
        ...
        add(txtState, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, 146, -1));

        txtSpecialization.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(txtSpecialization, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 330, 146, -1));
        ...
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 360, -1, -1));

        comboGender.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        comboGender.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Male", "Female" }));
        add(comboGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 260, -1, -1));

        jLabel9.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel9.setText("Specialization:");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, -1, -1));

        jLabel8.setFont(new java.awt.Font("Lucida Grande", 3, 14)); // NOI18N
        jLabel8.setText("Add your Details Here -");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 20, -1, -1));
        ...
        add(dobDateField, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 290, 150, -1));
