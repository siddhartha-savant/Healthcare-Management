...
public class VolunteerReceiverRequestJPanel extends javax.swing.JPanel {
    ...
    private void populateRequestTable(){
        ...
        dtm.setRowCount(0);
         ...
         for(PatientRequest patientRequest: system.getPatientRequestList().getPatientRequestList()){            
            Object row[] = new Object[5];
            row[0]= patientRequest;
            row[1]= patientRequest.getNameOfPatientRequest();
            row[2]= patientRequest.getContact();
            row[3]= patientRequest.getDisease();
    ...
    private void initComponents() {
        ...
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 630, -1, -1));
        ...
        jLabel25.setText("Patient Request Center");
        ...
        add(labConfirmationText, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 580, 200, -1));
        ...
        requestTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "UID", "Name", "Contact", "Disease", "Status"
            }
        ) {
        ...
        add(statusText, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 520, 200, -1));
        ...
        add(diagnosedDateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 630, 170, -1));

        jLabel2.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        jLabel2.setText("Status");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 520, -1, -1));
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/faint-bggg.jpeg"))); // NOI18N
        add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 1580, 840));
    ...
    private void buttonApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonApproveActionPerformed
        ...
        try {
            patient.getHLA().AntigenUpdationList(hlaText.getText());
        }
        catch (Exception e) {
        ...
        patient.setNameOfPatient(nameText.getText());
        patient.setContact(Long.parseLong(contactText.getText()));  
        
        patient.setIdOfPatient(uidText.getText()); // UID, receiverID
        patient.setNameOfPatient(nameText.getText()); // Name
       
       
        
        patient.setAgeOfPatient(Integer.parseInt(ageText.getText())); // Age
        ...
        patient.setLabVerification(true); //  labConfirmation
        system.getPatientList().addPatient(patient);
      
        
        for(PatientRequest patientRequest: system.getPatientRequestList().getPatientRequestList()){                      
        
            if(patientRequest.getIDofPatientRequest().equals(uidText.getText())){
    ...
    private void buttonRejectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRejectActionPerformed
       ...
       if(!statusText.getText().equals("New Request"))
        ...
        for(PatientRequest patientRequest: system.getPatientRequestList().getPatientRequestList()){                      
            ...
            if(patientRequest.getNameOfPatientRequest().equals(nameText.getText())){
    ...
    private void populateRequestDetails(PatientRequest patientRequest) {
            uidText.setText(patientRequest.getIDofPatientRequest());
            nameText.setText(patientRequest.getNameOfPatientRequest());
            dobDateField.setDate(patientRequest.getDateOfBirth());
            diagnosedDateChooser.setDate(patientRequest.getDiagnosisDate());
            ageText.setText(String.valueOf(patientRequest.getAge()));
            genderText.setText(patientRequest.getGender());
            hlaText.setText(String.join(", ", (Iterable<String>) patientRequest.getHla().listOfAntigentValues()));
