...
public class PatientStatusJPanel extends javax.swing.JPanel {
    ...
    private void populatePatientTable(){
        ...
        dtm.setRowCount(0);
         ...
         {            
            ...
            row[0]= patient;
            row[1]=patient.getNameOfPatient();
     ...
     private void populatePatientRequestsTable(){
        ...
        dtm.setRowCount(0);
         ...
         for(PatientRequest patient: system.getPatientRequestList().getPatientRequestList())
         {            
            Object row[] = new Object[4];
            row[0]= patient;
            row[1]=patient.getNameOfPatientRequest();
            row[2]=patient.getContact();
            row[3]=patient.getStatus();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("See all Patient request below");
        ...
        add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 640, 190, 40));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 1570, 830));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        system.getPatientRequestList().removePatientRequest(dr);
