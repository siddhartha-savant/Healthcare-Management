...
public abstract class WorkRequest {
    ...
    public UserAccount getPathUser() {
        return pathUser;
    }

    public void setPathUser(UserAccount pathUser) {
    ...
    public String getRequestNumber() {
        ...
        else if(requestNumber.equals("Request number not set yet"))
            this.setRequestNumber(Integer.toString(requestNumberInt));
